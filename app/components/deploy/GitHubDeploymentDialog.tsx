    ...
    try {
      ...
      try {
        ...
        const { data: commitData } = await octokit.git.createCommit({
          owner: connection.user.login,
          repo: sanitizedRepoName,
          message: !repoExists ? 'Initial commit from Arrow.dev' : 'Update from Arrow.dev',
          tree: treeData.sha,
              ...
              >
                ...
                <div className="relative text-center space-y-4">
                  ...
                  <motion.div
                    ...
                    className="mx-auto w-16 h-16 rounded-xl bg-arrow-elements-background-depth-3 flex items-center justify-center text-purple-500"
                  >
              ...
              <div className="p-6">
                <div className="flex items-center gap-4 mb-6">
                  <motion.div
                    ...
                    animate={{ scale: 1 }}
                    transition={{ delay: 0.1 }}
                    className="w-10 h-10 rounded-xl bg-arrow-elements-background-depth-3 flex items-center justify-center text-purple-500"
                  >
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 px-4 py-2 rounded-lg bg-arrow-elements-background-depth-2 dark:bg-arrow-elements-background-depth-3 border border-arrow-elements-borderColor dark:border-arrow-elements-borderColor-dark text-arrow-elements-textPrimary dark:text-arrow-elements-textPrimary-dark placeholder-arrow-elements-textTertiary dark:placeholder-arrow-elements-textTertiary-dark focus:outline-none focus:ring-2 focus:ring-purple-500"
                        required
                        maxLength={100}
                    ...
                    {repoName && sanitizeRepoName(repoName) !== repoName && (
                      <p className="text-xs text-arrow-elements-textSecondary dark:text-arrow-elements-textSecondary-dark mt-1">
                        Will be created as:{' '}
                            ...
                            >
                              <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                  ...
                                  <span className="text-sm font-medium text-arrow-elements-textPrimary dark:text-arrow-elements-textPrimary-dark group-hover:text-purple-500">
                                    {repo.name}
                                  </span>
                                </div>
                                {repo.private && (
                  ...
                  <div className="p-3 bg-arrow-elements-background-depth-2 dark:bg-arrow-elements-background-depth-3 rounded-lg border border-arrow-elements-borderColor dark:border-arrow-elements-borderColor-dark">
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        className="rounded border-arrow-elements-borderColor dark:border-arrow-elements-borderColor-dark text-purple-500 focus:ring-purple-500 dark:bg-arrow-elements-background-depth-3"
                      />
                      <label
                        htmlFor="private"
