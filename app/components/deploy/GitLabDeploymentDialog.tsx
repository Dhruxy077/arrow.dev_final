      ...
      <Dialog.Root open={isOpen} onOpenChange={(open) => !open && handleClose()}>
        <Dialog.Portal>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-[9999]">
            ...
            >
              <Dialog.Content
                className="bg-white dark:bg-arrow-elements-background-depth-1 rounded-lg border border-arrow-elements-borderColor dark:border-arrow-elements-borderColor-dark shadow-xl"
                ...
                <div className="p-6 space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="text-lg font-medium text-arrow-elements-textPrimary dark:text-arrow-elements-textPrimary-dark">
                          Successfully pushed to GitLab
                        </h3>
                        <p
                          id="success-dialog-description"
                          className="text-sm text-arrow-elements-textSecondary dark:text-arrow-elements-textSecondary-dark"
                        >
                    ...
                    <Dialog.Close asChild>
                      <button
                        onClick={handleClose}
                        className="p-2 rounded-lg transition-all duration-200 ease-in-out bg-transparent text-arrow-elements-textTertiary hover:text-arrow-elements-textPrimary dark:text-arrow-elements-textTertiary-dark dark:hover:text-arrow-elements-textPrimary-dark hover:bg-arrow-elements-background-depth-2 dark:hover:bg-arrow-elements-background-depth-3 focus:outline-none focus:ring-2 focus:ring-arrow-elements-borderColor dark:focus:ring-arrow-elements-borderColor-dark"
                      >
                  ...
                  <div className="bg-arrow-elements-background-depth-2 dark:bg-arrow-elements-background-depth-3 rounded-lg p-4 text-left border border-arrow-elements-borderColor dark:border-arrow-elements-borderColor-dark">
                    <p className="text-sm font-medium text-arrow-elements-textPrimary dark:text-arrow-elements-textPrimary-dark mb-2 flex items-center gap-2">
                      <span className="i-ph:gitlab-logo w-4 h-4 text-orange-500" />
                      Repository URL
                    </p>
                    <div className="flex items-center gap-2">
                      <code className="flex-1 text-sm bg-arrow-elements-background-depth-1 dark:bg-arrow-elements-background-depth-4 px-3 py-2 rounded border border-arrow-elements-borderColor dark:border-arrow-elements-borderColor-dark text-arrow-elements-textPrimary dark:text-arrow-elements-textPrimary-dark font-mono">
                        {createdRepoUrl}
                      </code>
                      <motion.button
                        onClick={() => {
                        ...
                        className="p-2 text-arrow-elements-textSecondary hover:text-arrow-elements-textPrimary dark:text-arrow-elements-textSecondary-dark dark:hover:text-arrow-elements-textPrimary-dark bg-arrow-elements-background-depth-1 dark:bg-arrow-elements-background-depth-4 rounded-lg border border-arrow-elements-borderColor dark:border-arrow-elements-borderColor-dark"
                  ...
                  <div className="bg-arrow-elements-background-depth-2 dark:bg-arrow-elements-background-depth-3 rounded-lg p-4 border border-arrow-elements-borderColor dark:border-arrow-elements-borderColor-dark">
                    <p className="text-sm font-medium text-arrow-elements-textPrimary dark:text-arrow-elements-textPrimary-dark mb-2 flex items-center gap-2">
                    ...
                    <div className="max-h-[200px] overflow-y-auto custom-scrollbar pr-2">
                      {pushedFiles.slice(0, 100).map((file) => (
                        <div
                          key={file.path}
                          className="flex items-center justify-between py-1.5 text-sm text-arrow-elements-textPrimary dark:text-arrow-elements-textPrimary-dark border-b border-arrow-elements-borderColor/30 dark:border-arrow-elements-borderColor-dark/30 last:border-0"
                        >
                          <span className="font-mono truncate flex-1 text-xs">{file.path}</span>
                          <span className="text-xs px-2 py-0.5 rounded-full bg-arrow-elements-background-depth-3 dark:bg-arrow-elements-background-depth-4 text-arrow-elements-textSecondary dark:text-arrow-elements-textSecondary-dark ml-2">
                            {formatSize(file.size)}
                          </span>
                        </div>
                      ))}
                      {pushedFiles.length > 100 && (
                        <div className="py-2 text-center text-xs text-arrow-elements-textSecondary dark:text-arrow-elements-textSecondary-dark">
                  ...
                  <div className="flex justify-end gap-2 pt-2">
                    ...
                    <motion.button
                      ...
                      className="px-4 py-2 rounded-lg bg-arrow-elements-background-depth-2 dark:bg-arrow-elements-background-depth-3 text-arrow-elements-textSecondary dark:text-arrow-elements-textSecondary-dark hover:bg-arrow-elements-background-depth-3 dark:hover:bg-arrow-elements-background-depth-4 text-sm inline-flex items-center gap-2 border border-arrow-elements-borderColor dark:border-arrow-elements-borderColor-dark"
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                    >
                      <div className="i-ph:copy w-4 h-4" />
                    ...
                    <motion.button
                      onClick={handleClose}
                      className="px-4 py-2 rounded-lg bg-arrow-elements-background-depth-2 dark:bg-arrow-elements-background-depth-3 text-arrow-elements-textSecondary dark:text-arrow-elements-textSecondary-dark hover:bg-arrow-elements-background-depth-3 dark:hover:bg-arrow-elements-background-depth-4 text-sm border border-arrow-elements-borderColor dark:border-arrow-elements-borderColor-dark"
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                    >
                      Close
      ...
      <Dialog.Root open={isOpen} onOpenChange={(open) => !open && handleClose()}>
        <Dialog.Portal>
          ...
          <div className="fixed inset-0 flex items-center justify-center z-[9999]">
            ...
            >
              <Dialog.Content
                className="bg-white dark:bg-arrow-elements-background-depth-1 rounded-lg p-6 border border-arrow-elements-borderColor dark:border-arrow-elements-borderColor-dark shadow-xl"
              ...
              >
                ...
                <div className="relative text-center space-y-4">
                  ...
                  <motion.div
                    ...
                    className="mx-auto w-16 h-16 rounded-xl bg-arrow-elements-background-depth-3 flex items-center justify-center text-orange-500"
                  >
                  ...
                  <p
                    ...
                    className="text-sm text-arrow-elements-textSecondary dark:text-arrow-elements-textSecondary-dark max-w-md mx-auto"
                  >
                    To deploy your code to GitLab, you need to connect your GitLab account first.
                  </p>
                  <div className="pt-2 flex justify-center gap-3">
                    <motion.button
                      className="px-4 py-2 rounded-lg bg-arrow-elements-background-depth-2 dark:bg-arrow-elements-background-depth-3 text-arrow-elements-textSecondary dark:text-arrow-elements-textSecondary-dark text-sm hover:bg-arrow-elements-background-depth-3 dark:hover:bg-arrow-elements-background-depth-4 border border-arrow-elements-borderColor dark:border-arrow-elements-borderColor-dark"
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                      onClick={handleClose}
                    >
              ...
              <div className="p-6">
                <div className="flex items-center gap-4 mb-6">
                  <motion.div
                    ...
                    animate={{ scale: 1 }}
                    transition={{ delay: 0.1 }}
                    className="w-10 h-10 rounded-xl bg-arrow-elements-background-depth-3 flex items-center justify-center text-orange-500"
                  >
                    <div className="i-ph:gitlab-logo w-5 h-5" />
                  </motion.div>
                  <div>
                    <Dialog.Title className="text-lg font-medium text-arrow-elements-textPrimary dark:text-arrow-elements-textPrimary-dark">
                      Deploy to GitLab
                    </Dialog.Title>
                    <p
                ...
                <div className="flex items-center gap-3 mb-6 p-4 bg-arrow-elements-background-depth-2 dark:bg-arrow-elements-background-depth-3 rounded-lg border border-arrow-elements-borderColor dark:border-arrow-elements-borderColor-dark">
                  <div className="relative">
                    ...
                    <div
                      className="avatar-fallback w-10 h-10 rounded-full bg-arrow-elements-background-depth-4 flex items-center justify-center text-arrow-elements-textSecondary font-semibold text-sm"
                      style={{
                        display:
                  ...
                  <div>
                    <p className="text-sm font-medium text-arrow-elements-textPrimary dark:text-arrow-elements-textPrimary-dark">
                      {user.name || user.username}
                    </p>
                    <p className="text-sm text-arrow-elements-textSecondary dark:text-arrow-elements-textSecondary-dark">
                      @{user.username}
                    </p>
                  </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <div className="absolute left-3 top-1/2 -translate-y-1/2 text-arrow-elements-textTertiary dark:text-arrow-elements-textTertiary-dark">
                      ...
                      <input
                        ...
                        className="w-full pl-10 px-4 py-2 rounded-lg bg-arrow-elements-background-depth-2 dark:bg-arrow-elements-background-depth-3 border border-arrow-elements-borderColor dark:border-arrow-elements-borderColor-dark text-arrow-elements-textPrimary dark:text-arrow-elements-textPrimary-dark placeholder-arrow-elements-textTertiary dark:placeholder-arrow-elements-textTertiary-dark focus:outline-none focus:ring-2 focus:ring-orange-500"
                        required
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between mb-2">
                      <label className="text-sm text-arrow-elements-textSecondary dark:text-arrow-elements-textSecondary-dark">
                        Recent Repositories
                      </label>
                      <span className="text-xs text-arrow-elements-textTertiary dark:text-arrow-elements-textTertiary-dark">
                    ...
                    <div className="mb-2">
                      <SearchInput
                        ...
                        className="bg-arrow-elements-background-depth-2 dark:bg-arrow-elements-background-depth-3 border border-arrow-elements-borderColor dark:border-arrow-elements-borderColor-dark text-sm"
                      />
                    </div>
                        ...
                        {filteredRepos.length === 0 && repoSearchQuery.trim() !== '' ? (
                          ...
                          filteredRepos.map((repo) => (
                            <motion.button
                              ...
                              className="w-full p-3 text-left rounded-lg bg-arrow-elements-background-depth-2 dark:bg-arrow-elements-background-depth-3 hover:bg-arrow-elements-background-depth-3 dark:hover:bg-arrow-elements-background-depth-4 transition-colors group border border-arrow-elements-borderColor dark:border-arrow-elements-borderColor-dark hover:border-orange-500/30"
                            ...
                            >
                              <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                  ...
                                  <span className="text-sm font-medium text-arrow-elements-textPrimary dark:text-arrow-elements-textPrimary-dark group-hover:text-orange-500">
                                    {repo.name}
                                  </span>
                                </div>
                              ...
                              {repo.description && (
                                <p className="mt-1 text-xs text-arrow-elements-textSecondary dark:text-arrow-elements-textSecondary-dark line-clamp-2">
                                  {repo.description}
                                </p>
                              )}
                  ...
                  <div className="p-3 bg-arrow-elements-background-depth-2 dark:bg-arrow-elements-background-depth-3 rounded-lg border border-arrow-elements-borderColor dark:border-arrow-elements-borderColor-dark">
                    <div className="flex items-center gap-2">
                      <input
                        type="checkbox"
                        id="private"
                        ...
                        className="rounded border-arrow-elements-borderColor dark:border-arrow-elements-borderColor-dark text-orange-500 focus:ring-orange-500 dark:bg-arrow-elements-background-depth-3"
                      />
                      <label
                        htmlFor="private"
                        className="text-sm text-arrow-elements-textPrimary dark:text-arrow-elements-textPrimary-dark"
                      >
                        Make repository private
                      </label>
                    </div>
                    <p className="text-xs text-arrow-elements-textTertiary dark:text-arrow-elements-textTertiary-dark mt-2 ml-6">
