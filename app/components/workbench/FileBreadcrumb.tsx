              ...
              <DropdownMenu.Trigger asChild>
                <span
                  ...
                  className={classNames('flex items-center gap-1.5 cursor-pointer shrink-0', {
                    'text-arrow-elements-textTertiary hover:text-arrow-elements-textPrimary': !isActive,
                    'text-arrow-elements-textPrimary underline': isActive,
                    'pr-4': isLast,
                  })}
                  onClick={() => handleSegmentClick(index)}
                >
                  {isLast && <div className={classNames(getFileIcon(segment), 'text-lg')} />}
                  {segment}
                </span>
                    ...
                    >
                      ...
                      >
                        <div className="rounded-lg overflow-hidden">
                          <div className="max-h-[50vh] min-w-[300px] overflow-scroll bg-arrow-elements-background-depth-1 border border-arrow-elements-borderColor shadow-sm rounded-lg">
                            <FileTree
                              files={files}
                              hideRoot
                              rootFolder={path}
                        ...
                        <DropdownMenu.Arrow className="fill-arrow-elements-borderColor" />
                      </motion.div>
                    </DropdownMenu.Content>
                  </DropdownMenu.Portal>
                )}
