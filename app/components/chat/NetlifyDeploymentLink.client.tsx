      ...
      <Tooltip.Root>
        <Tooltip.Trigger asChild>
          <a
            ...
            className="inline-flex items-center justify-center w-8 h-8 rounded hover:bg-arrow-elements-item-backgroundActive text-arrow-elements-textSecondary hover:text-[#00AD9F] z-50"
            onClick={(e) => {
        ...
        <Tooltip.Portal>
          <Tooltip.Content
            className="px-3 py-2 rounded bg-arrow-elements-background-depth-3 text-arrow-elements-textPrimary text-xs z-50"
            sideOffset={5}
          >
            {deployedSite.url}
            <Tooltip.Arrow className="fill-arrow-elements-background-depth-3" />
          </Tooltip.Content>
        </Tooltip.Portal>
      </Tooltip.Root>
    </Tooltip.Provider>
