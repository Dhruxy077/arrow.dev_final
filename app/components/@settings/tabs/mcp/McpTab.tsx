    ...
    <div className="max-w-2xl mx-auto space-y-6">
      <section aria-labelledby="server-status-heading">
        <div className="flex justify-between items-center mb-3">
          <h2 className="text-base font-medium text-arrow-elements-textPrimary">MCP Servers Configured</h2>{' '}
          <button
            onClick={checkServerAvailability}
            disabled={isCheckingServers || !parsedConfig || serverEntries.length === 0}
            className={classNames(
              'px-3 py-1.5 rounded-lg text-sm',
              'bg-arrow-elements-background-depth-3 hover:bg-arrow-elements-background-depth-4',
          ...
          >
            {isCheckingServers ? (
              <div className="i-svg-spinners:90-ring-with-bg w-3 h-3 text-arrow-elements-loader-progress animate-spin" />
            ) : (
      ...
      <section aria-labelledby="config-section-heading">
        <h2 className="text-base font-medium text-arrow-elements-textPrimary mb-3">Configuration</h2>

        <div className="space-y-4">
          <div>
            <label htmlFor="mcp-config" className="block text-sm text-arrow-elements-textSecondary mb-2">
              Configuration JSON
            </label>
            <textarea
              id="mcp-config"
              ...
              className={classNames(
                ...
                'border',
                error ? 'border-arrow-elements-icon-error' : 'border-[#E5E5E5] dark:border-[#333333]',
                'text-arrow-elements-textPrimary',
                'focus:outline-none focus:ring-1 focus:ring-arrow-elements-focus',
              )}
            />
          </div>
          <div>{error && <p className="mt-2 mb-2 text-sm text-arrow-elements-icon-error">{error}</p>}</div>
          <div>
            <label htmlFor="max-llm-steps" className="block text-sm text-arrow-elements-textSecondary mb-2">
            ...
            <input
              ...
              className="w-full px-3 py-2 text-arrow-elements-textPrimary text-sm rounded-lg bg-white dark:bg-arrow-elements-background-depth-4 border border-arrow-elements-borderColor dark:border-arrow-elements-borderColor-dark focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
          <div className="mt-2 text-sm text-arrow-elements-textSecondary">
            ...
            <a
              ...
              className="text-arrow-elements-link hover:underline inline-flex items-center gap-1"
            >
      ...
      <div className="flex flex-wrap justify-between gap-3 mt-6">
        <button
          ...
          className="px-4 py-2 rounded-lg text-sm border border-arrow-elements-borderColor
                    bg-arrow-elements-background-depth-2 text-arrow-elements-textSecondary
        ...
        <div className="flex gap-2">
          <button
            ...
            className={classNames(
              ...
              'hover:bg-arrow-elements-item-backgroundActive',
              'disabled:opacity-50 disabled:cursor-not-allowed',
            )}
          >
