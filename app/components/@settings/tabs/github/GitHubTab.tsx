    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center gap-2">
          <GithubLogo />
          <h2 className="text-lg font-medium text-arrow-elements-textPrimary">GitHub Integration</h2>
        </div>
      ...
      <div className="space-y-6">
        ...
        >
          ...
          <div className="flex items-center gap-2">
            {connection?.rateLimit && (
              <div className="flex items-center gap-2 px-3 py-1 bg-arrow-elements-background-depth-1 rounded-lg text-xs">
                <div className="i-ph:cloud w-4 h-4 text-arrow-elements-textSecondary" />
                <span className="text-arrow-elements-textSecondary">
        ...
        {stats?.repos && stats.repos.length > 0 && (
          <motion.div
            ...
            className="border-t border-arrow-elements-borderColor pt-6"
          >
                ...
                <div className="flex items-center justify-between p-4 rounded-lg bg-arrow-elements-background dark:bg-arrow-elements-background-depth-2 border border-arrow-elements-borderColor dark:border-arrow-elements-borderColor hover:border-arrow-elements-borderColorActive/70 dark:hover:border-arrow-elements-borderColorActive/70 transition-all duration-200">
                  ...
                  <ChevronDown
                    className={classNames(
                      'w-4 h-4 transform transition-transform duration-200 text-arrow-elements-textSecondary',
                  ...
                  {stats.repos.length > 12 && !isReposExpanded && (
                    <div className="text-center">
                      <Button
                        ...
                        className="text-arrow-elements-textSecondary hover:text-arrow-elements-textPrimary"
                      >
        ...
        {isConnected && connection && (
          <div className="mt-8 pt-6 border-t border-arrow-elements-borderColor">
