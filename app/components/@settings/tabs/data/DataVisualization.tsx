...
export function DataVisualization({ chats }: DataVisualizationProps) {
  ...
  const chartColors = {
    ...
    text: getThemeColor('--arrow-elements-textPrimary'),
    textSecondary: getThemeColor('--arrow-elements-textSecondary'),
    background: getThemeColor('--arrow-elements-bg-depth-1'),
    accent: getThemeColor('--arrow-elements-button-primary-text'),
    border: getThemeColor('--arrow-elements-borderColor'),
  };
  ...
  const getChartColors = (index: number) => {
    ...
    const baseColors = [
      // Indigo
      {
        base: getThemeColor('--arrow-elements-button-primary-text'),
      },
      ...
      // Green
      {
        base: getThemeColor('--arrow-elements-icon-success'),
      },
  ...
  if (chats.length === 0) {
    return (
      <div className="text-center py-8">
        <div className="i-ph-chart-line-duotone w-12 h-12 mx-auto mb-4 text-arrow-elements-textTertiary opacity-80" />
        <h3 className="text-lg font-medium text-arrow-elements-textPrimary mb-2">No Data Available</h3>
        <p className="text-arrow-elements-textSecondary">
  ...
  const cardClasses = classNames(
    ...
    'bg-arrow-elements-bg-depth-1',
    'border border-arrow-elements-borderColor',
  );

  const statClasses = classNames('text-3xl font-bold text-arrow-elements-textPrimary', 'flex items-center gap-3');

  return (
    <div className="space-y-8">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-arrow-elements-textPrimary mb-4">Total Chats</h3>
        ...
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-arrow-elements-textPrimary mb-4">Total Messages</h3>
          <div className={statClasses}>
        ...
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-arrow-elements-textPrimary mb-4">Avg. Messages/Chat</h3>
          <div className={statClasses}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-arrow-elements-textPrimary mb-6">Chat History</h3>
          <div className="h-64">
        ...
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-arrow-elements-textPrimary mb-6">Message Distribution</h3>
          <div className="h-64">
      ...
      {apiKeyUsage.length > 0 && (
        <div className={cardClasses}>
          <h3 className="text-lg font-medium text-arrow-elements-textPrimary mb-6">API Usage by Provider</h3>
          <div className="h-64">
