...
export const DropdownItem = ({ children, onSelect, className }: DropdownItemProps) => (
  <DropdownMenu.Item
    className={classNames(
      ...
      'text-arrow-elements-textPrimary hover:text-arrow-elements-textPrimary',
...
export const DropdownSeparator = () => <DropdownMenu.Separator className="h-px bg-arrow-elements-borderColor my-1" />;
