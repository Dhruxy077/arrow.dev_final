        ...
        <button
          ...
          className={classNames(
            ...
            tab.id === activeTab
              ...
              : classNames(
                  'bg-arrow-elements-background-depth-2 dark:bg-arrow-elements-background-depth-3 text-arrow-elements-textPrimary dark:text-arrow-elements-textPrimary-dark hover:bg-arrow-elements-background-depth-3 dark:hover:bg-arrow-elements-background-depth-4 border border-arrow-elements-borderColor dark:border-arrow-elements-borderColor-dark',
                  tabClassName,
                ),
          )}
        >
