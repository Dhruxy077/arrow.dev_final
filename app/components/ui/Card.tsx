  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-arrow-elements-borderColor bg-arrow-elements-background-depth-1 text-arrow-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-arrow-elements-textSecondary', className)} {...props} />;
  },
);
